...
{
    public class AndroidCentralViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "AndroidCentralDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new AndroidCentralDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("AndroidCentralDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("AndroidCentralDetail");
        }
    }
}
