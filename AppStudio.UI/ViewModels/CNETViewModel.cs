...
{
    public class CNETViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "CNETDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new CNETDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("CNETDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("CNETDetail");
        }
    }
}
