...
{
    public class CrackBerryViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "CrackBerryDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new CrackBerryDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("CrackBerryDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("CrackBerryDetail");
        }
    }
}
