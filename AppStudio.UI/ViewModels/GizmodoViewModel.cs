...
{
    public class GizmodoViewModel : ViewModelBase<RssSchema>
    {
        ...
        {
            return new GizmodoDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("GizmodoDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("GizmodoDetail");
        }
    }
}
