...
{
    public class PCWORLDViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "PCWORLDDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new PCWORLDDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("PCWORLDDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("PCWORLDDetail");
        }
    }
}
