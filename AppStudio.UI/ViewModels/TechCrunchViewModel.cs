...
{
    public class TechCrunchViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "TechCrunchDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new TechCrunchDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("TechCrunchDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("TechCrunchDetail");
        }
    }
}
