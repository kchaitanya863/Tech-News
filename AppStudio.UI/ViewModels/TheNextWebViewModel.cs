...
{
    public class TheNextWebViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "TheNextWebDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new TheNextWebDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("TheNextWebDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("TheNextWebDetail");
        }
    }
}
