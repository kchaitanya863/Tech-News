...
{
    public class WebOSViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "WebOSDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new WebOSDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("WebOSDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("WebOSDetail");
        }
    }
}
