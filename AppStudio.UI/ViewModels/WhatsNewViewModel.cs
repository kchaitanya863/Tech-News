...
{
    public class WhatsNewViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "WhatsNewDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new WhatsNewDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("WhatsNewDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("WhatsNewDetail");
        }
    }
}
