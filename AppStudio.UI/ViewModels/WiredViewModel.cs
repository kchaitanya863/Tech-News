...
{
    public class WiredViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "WiredDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new WiredDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("WiredDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("WiredDetail");
        }
    }
}
